...
public class IrisData {
	public static double[][] getSmallRawData() {
		double[][] allData = new double[10][];
	      allData[0] = new double[] { 25.6, 17.6, 7.1, 1.1, 0, 0 };
	      allData[1] = new double[] { 24.6, 15.1, 7.1, 1.1, 0, 0 };
	      allData[2] = new double[] { 25.1, 16.6, 7.1, 1.1, 0, 0 };
	      allData[3] = new double[] { 35.1, 16.1, 23.6, 7.1, 0, 1 };
	      allData[4] = new double[] { 32.1, 16.1, 22.6, 7.6, 0, 1 };
	      allData[5] = new double[] { 34.6, 15.6, 24.6, 7.6, 0, 1 };
	      allData[6] = new double[] { 27.6, 11.6, 20.1, 6.6, 0, 1 };
	      allData[7] = new double[] { 32.6, 14.1, 23.1, 7.6, 0, 1 };
	      allData[8] = new double[] { 25.1, 16.1, 6.1, 1.1, 0, 0 };
	      allData[9] = new double[] { 27.6, 17.6, 6.6, 1.1, 0, 0 };
	    return allData;
	}
	public static double[] getSmallDataResult(){
		return new double[]{1,1,1,0,0,0,0,0,1,1};
	}
